  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addressList" :key="address.id">
        ...
        <p @click="changeAddressDef(address, addressList)">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(goods, index) in tradeList.detailArrayList" :key="index">
          <li>
...
export default {
  ...
  computed: {
    ...
    //用户选择的默认地址
    userDefaultAddress() {
      return this.addressList.find(iteam => iteam.isDefault == 1) || {}
    },
    addressList() {
  ...
  methods: {
    changeAddressDef(adderss, addressList) {
      addressList.forEach(iteam => {
        iteam.isDefault = '0'
      });
      adderss.isDefault = '1'
    },
