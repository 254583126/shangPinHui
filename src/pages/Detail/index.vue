          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr, index) in spuSaleAttrList" :key="attr.id">
                ...
                <dd :class="{ active: spuattr.isChecked == 1 }" v-for="(spuattr, index) in attr.spuSaleAttrValueList"
                  :key="spuattr.id" @click="changeActive(spuattr,attr.spuSaleAttrValueList)">{{ spuattr.saleAttrValueName }}</dd>
              </dl>
